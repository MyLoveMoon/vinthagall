...
async def start(event):
  await event.reply(
    "__**𝐈'𝐦 📌𝐆𝐫𝐨𝐨𝐭 𝐓𝐚𝐠 𝐀𝐥𝐥 𝐁𝐨𝐭**, 𝐢 𝐂𝐚𝐧 𝐌𝐞𝐧𝐭𝐢𝐨𝐧 𝐀𝐥𝐥 𝐌𝐞𝐦𝐛𝐞𝐫𝐬 𝐈𝐧 𝐆𝐫𝐨𝐮𝐩 𝐎𝐫 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 👻\n𝐂𝐥𝐢𝐜𝐤 **/help** 𝐅𝐨𝐫 𝐌𝐨𝐫𝐞 𝐈𝐧𝐟𝐨𝐫𝐦𝐚𝐭𝐢𝐨𝐧__\n\n 𝐅𝐨𝐥𝐥𝐨𝐰 [𝐈𝐚𝐦 𝐆𝐫𝐨𝐨𝐭](https://t.me/rjbr0) 𝗢𝗻 𝐓𝐞𝐥𝐞𝐆𝐫𝐚𝐦",
    link_preview=False,
    buttons=(
      [
        Button.url('𝐆-𝐍𝐞𝐭𝐰𝐨𝐫𝐤🧡', 'https://t.me/groot_network'),
        Button.url('𝐆-𝐍𝐞𝐭𝐰𝐨𝐫𝐤💚', 'https://t.me/rjbr0')
      ]
    )
  )
...
async def help(event):
  helptext = "**Help Menu of 📌𝐆𝐫𝐨𝐨𝐭 𝐓𝐚𝐠𝐀𝐥𝐥 𝐁𝐨𝐭**\n\nCommand: /all\n__You can use this command with text what you want to mention others.__\nExample: `/all Good Morning!`\n__You can you this command as a reply to any message. Bot will tag users to that replied messsage__.\n\n"
  await event.reply(
    helptext,
    link_preview=False,
    buttons=(
